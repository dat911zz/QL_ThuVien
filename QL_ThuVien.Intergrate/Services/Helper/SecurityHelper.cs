...
namespace QL_ThuVien.Intergrate.Services.Helper
{
    public static class SecurityHelper
    {
        ...
        public static bool HasPermission(HttpContext httpContext)
        {
            string[] permissions = new string[] { "Quản trị viên", "Nhân Viên" };
            return permissions.Any(role => httpContext.User.IsInRole(role));        
        }
